...
<body class="contatiner">
    ...
    <h1>Exercicio 18</h1>
    <form action="resp18.php" method="POST">
        <div class="row m-5">
            <div class="col">
                <p>Informe seu peso em Kg</p>
                <label for="valor1">Informe o produto:</label>
                <input type="number" class="form-control" name="valor1" id="valor1">
            </div>
            <div class="col">
                <p>Infrome sua altura</p>
                <label for="valor2">Informe o valor da taxa:</label>
                <input type="number" class="form-control" name="valor2" id="valor2">
            </div>
            <div class="col">
                <p>Infrome sua altura</p>
                <label for="valor2">Informe o periodo que sera taxado:</label>
